...
exports.getGapInformation = getGapInformation;
exports.markSubTrees = markSubTrees;
exports.DiffTracker = exports.Diff = void 0;
  ...
  if (e1.attributes && e2.attributes) {
    if (e1.attributes.id) {
      if (e1.attributes.id !== e2.attributes.id) {
        ...
        const idDescriptor = "".concat(e1.nodeName, "#").concat(e1.attributes.id);
    ...
    if (e1.attributes['class'] && e1.attributes['class'] === e2.attributes['class']) {
      const classDescriptor = "".concat(e1.nodeName, ".").concat(e1.attributes['class'].replace(/ /g, '.'));
...
function getGapInformation(t1, t2, stable) {
  ...
  let group = 0; // give elements from the same subset the same group number
...
function markSubTrees(oldTree, newTree) {
  ...
  const returnIndex = function returnIndex() {
    return arguments[1];
  };
...
exports.DiffTracker = DiffTracker;