...
exports.applyVirtual = applyVirtual;
...
function applyVirtualDiff(tree, diff, options // {preDiffApply, postDiffApply, _const}
) {
  ...
  const newSubsets = []; // pre-diff hook
  ...
  switch (diff[options._const.action]) {
    ...
    case options._const.replaceElement:
      newNode = (0, _helpers.cloneObj)(diff[options._const.newValue]);
    ...
    case options._const.addElement:
      ...
      newNode = (0, _helpers.cloneObj)(diff[options._const.element]);
      newNode.outerDone = true;
      newNode.innerDone = true;
      newNode.valueDone = true;
