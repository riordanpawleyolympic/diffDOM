...
exports.applyDOM = applyDOM;

var _fromVirtual = require("./fromVirtual");
...
function applyDiff(tree, diff, options // {preDiffApply, postDiffApply, textDiff, valueDiffing, _const}
  ...
  switch (diff[options._const.action]) {
    ...
    case options._const.replaceElement:
      node.parentNode.replaceChild((0, _fromVirtual.objToNode)(diff[options._const.newValue], node.namespaceURI === 'http://www.w3.org/2000/svg', options), node);
      break;
    ...
    case options._const.addElement:
      ...
      node.insertBefore((0, _fromVirtual.objToNode)(diff[options._const.element], node.namespaceURI === 'http://www.w3.org/2000/svg', options), node.childNodes[c] || null);
      break;
